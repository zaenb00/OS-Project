def sjf_scheduler(processes, num_cores=1):
    time = 0
    ready_queue = []
    completed = []
...
if __name__ == "__main__":
    try:
        ...
        raise SystemExit("Please run this module as a package: 'python -m src.schedulers.sjf' from the project root (not by running the .py file directly).")
    ...
    completed, total_time, idle_time = sjf_scheduler(processes, num_cores=2)
